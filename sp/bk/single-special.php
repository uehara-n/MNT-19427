...
<? if(post_custom('special_image')){ ?>
  ...
  <table class="syosai">
              ...
              $text4 = post_custom('special_hiyou');
...
if(post_custom('special_cust_voice')){ ?>
        ...
        <? if(post_custom('special_before_image1')): ?>
          <br clear="all">
              <div class="block block_b">
                ...
                <div id="pic_area">
                  <? if(post_custom('special_before_image1')): ?>
                      ...
                      <a href="<? echo gr_get_image_src('special_before_image1'); ?>" rel="lightbox[special_before_image]" ><? echo gr_get_image( 'special_before_image1', array( 'width' => 210 ) ); ?></a>
                		</div>
                  <?php endif; ?>
                  <? if(post_custom('special_before_image2')): ?>
                		<div class="clear_left">
                      <a href="<? echo gr_get_image_src('special_before_image2'); ?>" rel="lightbox[special_before_image]" ><? echo gr_get_image( 'special_before_image2', array( 'width' => 210 ) ); ?></a>
                		</div>
                  <?php endif; ?>
                  <? if(post_custom('special_before_image3')): ?>
                		<div class="clear_left">
                      <a href="<? echo gr_get_image_src('special_before_image3'); ?>" rel="lightbox[special_before_image]" ><? echo gr_get_image( 'special_before_image3', array( 'width' => 210 ) ); ?></a>
                		</div>
                  <?php endif; ?>
                </div>
                ...
                <br clear="all">
                <div class="">
                  <h4 class="new_nayami_h4"><span class="nayami_square">■</span> お困りごと・お悩み</h4>
                  <p class="txt"><? echo nl2br(post_custom('special_nayami')); ?></p>
                </div><!-- .picup  -->
              </div>
        <?php endif; ?>
...
<div class="box<?php if($i%2==0){ echo " clear_left";$n++; } ?>"><a href="<?php the_permalink(); ?>" class="heightLine-group<?php echo $n; ?>"><p class="pic"><?php if(post_custom('special_t_image')){echo gr_get_image( 'special_t_image', array( 'width' => 215 ) );}
